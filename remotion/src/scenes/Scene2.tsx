...
const { fontFamily: sansFont } = loadSans("normal", { weights: ["300"], subsets: ["latin"] });
    ...
    <AbsoluteFill style={{ background: "#1a130c" }}>
      ...
      <div style={{ position: "absolute", right: 100, top: 0, width: "40%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center" }}>
        <div style={{ opacity: textOp, transform: `translateY(${textY}px)` }}>
          <div style={{ fontFamily: sansFont, fontSize: 13, color: "rgba(210,190,165,0.6)", letterSpacing: "0.3em", textTransform: "uppercase", fontWeight: 300, marginBottom: 20 }}>
            Herbal Therapy
          </div>
        ...
        <div style={{ opacity: descOp, transform: `translateY(${descY}px)`, fontFamily: sansFont, fontSize: 18, color: "rgba(210,190,165,0.7)", lineHeight: 1.7, fontWeight: 300, maxWidth: 420 }}>
