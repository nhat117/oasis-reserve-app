...
export const EN_TRANSLATIONS: Record<string, string> = {
  ...
  "Yêu cầu đặt lịch của bạn đã được ghi nhận — vui lòng chờ nhân viên xác nhận trước ngày hẹn.": "Your booking request has been received — please wait for confirmation from our staff before your appointment.",
  ...
  "Thêm sản phẩm mới vào hệ thống": "Add a new product to the system",
  "Sửa sản phẩm": "Edit Product",
  "Chỉnh sửa thông tin sản phẩm": "Edit product details",
  "Chưa có sản phẩm": "No products yet",
  "Tên sản phẩm": "Product Name",
  "Mô tả ngắn về sản phẩm...": "Short product description...",
  "Đã thêm sản phẩm": "Product added",
  "Đã cập nhật sản phẩm": "Product updated",
  "Đã xoá sản phẩm": "Product deleted",
  "Xoá sản phẩm": "Delete Product",
  ...
  "Tiền tip": "Tip",
  "Tiền tip theo thợ": "Tips by staff",
  "Không tip": "No tip",
  "Số tiền tip": "Tip amount",
  "Chọn thợ (tuỳ chọn)": "Select staff (optional)",
  "Khác": "Other",
  ...
  "Giờ làm việc theo ngày": "Weekly Working Hours",
  "Làm việc": "Work",
  ...
  "Thứ 7": "Sat",
  "Chủ nhật": "Sun",
  "Chưa cài giờ làm việc": "Hours not set",
  "ngày/tuần": "days/wk",
  "Nghỉ": "Off",
  ...
  "Nhân viên đã xoá": "Deleted staff",
  "Các nhân viên này đã bị xoá nhưng còn lịch sử nên được ẩn thay vì xoá hoàn toàn. Bạn có thể kích hoạt lại.": "These staff members were deleted but have history, so they were hidden instead of permanently removed. You can reactivate them.",
  "Chuyển lịch hẹn trước khi xoá": "Transfer bookings before deleting",
  "Nhân viên này còn lịch hẹn sắp tới. Chọn nhân viên khác đang rảnh cho từng lịch hẹn trước khi xoá.": "This staff member still has upcoming bookings. Choose another available staff member for each booking before deleting.",
  "Chọn nhân viên thay thế": "Choose a replacement staff member",
  "Không có nhân viên nào rảnh cho lịch hẹn này": "No staff member is available for this booking",
  "Xác nhận chuyển & xoá": "Confirm transfer & delete",
  "Đã ẩn mã giảm giá": "Discount code hidden",
  "Mã này đã được sử dụng nên không thể xoá hoàn toàn. Đã chuyển sang trạng thái tắt để giữ lịch sử sử dụng.": "This code has already been used, so it can't be permanently deleted. It's been turned off instead to keep usage history intact.",
  "Mã này đã được sử dụng nên không thể xoá hoàn toàn. Sẽ chuyển sang trạng thái tắt để giữ lịch sử sử dụng.": "This code has already been used, so it can't be permanently deleted. It will be turned off instead to keep usage history intact.",
  "Tạo theo lô": "Batch create",
  "Tạo mã giảm giá theo lô": "Batch create discount codes",
  "Tạo nhiều mã giảm giá cùng lúc, mỗi mã có hậu tố ngẫu nhiên riêng": "Create multiple discount codes at once, each with its own random suffix",
  "Tiền tố (không bắt buộc)": "Prefix (optional)",
  "Ví dụ": "Example",
  "Số lượng mã": "Number of codes",
  "Giới hạn sử dụng mỗi mã": "Usage limit per code",
  "Đang tạo...": "Creating...",
  "mã": "codes",
  "Đã tạo mã giảm giá": "Discount codes created",
  "mã đã được tạo": "codes were created",
  "Số lượng phải từ 1 đến 500": "Quantity must be between 1 and 500",
  "Cần nhập giá trị giảm": "A discount value is required",
  "Tạo nhiều thẻ quà tặng hoặc mã giảm giá cùng lúc": "Create multiple gift cards or discount codes at once",
  "Giá trị mỗi thẻ (A$)": "Value per card (A$)",
  "Số lượng thẻ": "Number of cards",
  "thẻ đã được tạo": "cards were created",
  "Cần nhập giá trị thẻ": "A card value is required",
  "Số lượng phải từ 1 đến 200": "Quantity must be between 1 and 200",
  "Đã tạo theo lô": "Batch created",
  "Tải file CSV": "Download CSV",
  "khác": "more",
  "Tạo ở trạng thái khoá (xem lại trước khi dùng)": "Create as locked (review before use)",
  "Tạo ở trạng thái tắt (xem lại trước khi dùng)": "Create as disabled (review before use)",
  "Mới nhất": "Newest",
  "Hết hạn sớm nhất": "Expiring soonest",
  "Số dư cao nhất": "Highest balance",
  "Dùng nhiều nhất": "Most used",
  "Xoá thẻ quà tặng": "Delete gift card",
  "Xoá thẻ quà tặng này?": "Delete this gift card?",
  "Thẻ này đã có giao dịch nên không thể xoá hoàn toàn. Sẽ chuyển sang trạng thái khoá để giữ lịch sử giao dịch.": "This card already has transaction history, so it can't be permanently deleted. It will be locked instead to keep the transaction history intact.",
  "Thẻ này đã có giao dịch nên không thể xoá hoàn toàn. Đã chuyển sang trạng thái khoá để giữ lịch sử giao dịch.": "This card already has transaction history, so it can't be permanently deleted. It's been locked instead to keep the transaction history intact.",
  "Đã xoá thẻ quà tặng": "Gift card deleted",
  "Chọn nhiều ngày": "Select multiple days",
  "Ngày kết thúc phải sau ngày bắt đầu": "End date must be after start date",
  "Khoảng ngày quá dài (tối đa 90 ngày)": "Date range is too long (90 days max)",
  "ngày đã được thêm": "days were added",
  ...
  "Chọn ngày trên lịch để thêm ngày nghỉ cho nhân viên": "Pick a date on the calendar to add a day off",
  "Chưa có ngày nghỉ tiệm nào": "No shop holidays yet",
  "Chọn ngày trên lịch để thêm ngày nghỉ": "Pick a date on the calendar to add a holiday",
  ...
  "Thuế": "Tax",
  "Loại thuế": "Tax Type",
  "Tên thuế tuỳ chỉnh": "Custom Tax Name",
  "Phần trăm thuế (%)": "Tax Percentage (%)",
  "Thuế sẽ được tự động cộng thêm vào mọi giao dịch thanh toán": "Tax is automatically added to every checkout",
  "Đã lưu thuế": "Tax rate saved",
  ...
  "Email khi có lịch mới": "Email on new booking",
  "Gửi email đến chủ tiệm khi khách đặt lịch mới": "Send email to owner when new booking arrives",
  "Email nhận thông báo": "Notification email",
  "Email chủ tiệm nhận thông báo khi có lịch hẹn mới. Cần cấu hình Resend trong Cài đặt email.": "Owner email to receive notifications on new bookings. Requires Resend to be configured in Email settings.",
  ...
  "thẻ": "cards",
  "Tạo thẻ quà tặng": "Create Gift Card",
  "Tạo thẻ": "Create Card",
  "Đã tạo thẻ quà tặng": "Gift card created",
  "Gửi mã này cho khách hàng": "Send this code to the customer",
  "Thẻ quà tặng có giá trị lưu trữ, khách dùng dần qua nhiều lần": "Gift cards carry a stored balance the customer can use across multiple visits",
  "Tên người mua": "Purchaser name",
  "Có hiệu lực đến": "Valid until",
  "Giá trị": "Value",
  "Tìm theo mã...": "Search by code...",
  "Chưa có thẻ quà tặng": "No gift cards yet",
  "Xong": "Done",
  "Chi tiết thẻ quà tặng": "Gift Card Details",
  "Số dư hiện tại": "Current balance",
  "Số dư": "Balance",
  "Ngày tạo": "Created",
  "Người mua": "Purchaser",
  "Khoá thẻ": "Disable Card",
  "Mở lại thẻ": "Re-enable Card",
  "Đã khoá thẻ": "Card disabled",
  "Đã mở lại thẻ": "Card re-enabled",
  "Điều chỉnh số dư": "Adjust Balance",
  "dương để cộng, âm để trừ": "positive to credit, negative to debit",
  "Lý do": "Reason",
  "bắt buộc": "required",
  "Đã điều chỉnh số dư": "Balance adjusted",
  "Cần nhập lý do": "A reason is required",
  "Không tìm thấy thẻ": "Card not found",
  "Số dư không đủ để trừ": "Insufficient balance",
  "Vượt quá giá trị ban đầu của thẻ": "Exceeds the card's original value",
  "Không thể điều chỉnh số dư": "Could not adjust balance",
  ...
  "Terminal POS & thanh toán qua thẻ/điện thoại": "Terminal POS & card/phone payments",
  "Nhập thông tin tài khoản Square. Bạn có thể tìm thông tin này tại": "Enter your Square account details. You can find this info at",
  "Máy POS Terminal": "POS Terminal",
  "Thanh toán qua thẻ / Tap to Pay": "Card / Tap to Pay",
  "Nhập thẻ / Tap to Pay": "Enter Card / Tap to Pay",
  "ID ứng dụng Square cho Web Payments SDK": "Square Application ID for Web Payments SDK",
  "Thanh toán thành công": "Payment successful",
  "Lỗi thanh toán": "Payment error",
  "Đang tải form thanh toán...": "Loading payment form...",
