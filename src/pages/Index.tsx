  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-screen flex items-end">
        ...
        <div className="relative w-full max-w-7xl mx-auto px-6 md:px-10 pb-20 md:pb-28">
          <div className="max-w-xl space-y-8">
            <p className="text-xs tracking-[0.3em] uppercase text-background/70">{t('Gội đầu dưỡng sinh')}</p>
            <h1 className="text-5xl md:text-7xl text-background leading-[1.1] font-light">
              {t('A Ritual for')}
              <br />
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-10 py-28 md:py-40">
        <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
          <div className="space-y-8">
            <p className="text-xs tracking-[0.3em] uppercase text-muted-foreground">{t('Về chúng tôi')}</p>
            <h2 className="text-4xl md:text-5xl leading-[1.15] font-light">
              {t('Nghệ thuật')}<br />
      ...
      <section className="border-y border-border/60">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-border/60">
            <div className="py-14 md:pr-10 space-y-3">
              <p className="text-xs tracking-[0.25em] uppercase text-muted-foreground">{t('Giờ mở cửa')}</p>
              <p className="text-foreground text-lg font-light">{t('9:00 SA – 6:00 CH')}</p>
              <p className="text-muted-foreground text-sm">{t('Thứ 2 – Thứ 7')}</p>
            </div>
            <div className="py-14 md:px-10 space-y-3">
              <p className="text-xs tracking-[0.25em] uppercase text-muted-foreground">{t('Liên hệ')}</p>
              ...
              <p className="text-muted-foreground text-sm">{t('hoặc đặt online 24/7')}</p>
            </div>
            <div className="py-14 md:pl-10 space-y-3">
              <p className="text-xs tracking-[0.25em] uppercase text-muted-foreground">{t('Địa chỉ')}</p>
              <p className="text-foreground text-lg font-light">{shopAddress || t('Liên hệ để biết địa chỉ chi tiết')}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-10 py-28 md:py-40 text-center">
        <p className="text-xs tracking-[0.3em] uppercase text-muted-foreground mb-6">{t('Sẵn sàng trải nghiệm?')}</p>
        <h2 className="text-4xl md:text-5xl font-light leading-[1.15] mb-8">
